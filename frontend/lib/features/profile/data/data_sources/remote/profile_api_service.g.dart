...
class _ProfileApiService implements ProfileApiService {
  ...
  @override
  Future<HttpResponse<void>> createProfile(CreateProfileModel profile) async {
  ...
  @override
  Future<HttpResponse<ProfileModel>> fetchUserProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<ProfileModel>> updateProfile(ProfileModel profile) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
